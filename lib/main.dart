  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // Agent work system providers
        ChangeNotifierProvider(create: (_) => ChecklistProvider()),
        ChangeNotifierProvider(create: (_) => AgentTimerProvider()),
        ChangeNotifierProvider(create: (_) => AgentAuditProvider()),
        ChangeNotifierProvider(create: (_) => AgentWorkProvider()),
